/**
 * Public Layout JavaScript
 * Handles theme switching, PJAX navigation, and scroll controls
 */
...
(function($) {
  ...
  const PublicLayout = {
    ...
    /**
     * Theme Toggle with Auto-switching based on time
     */
    ...
    /**
     * PJAX Navigation with loading indicators and fallbacks
     */
    initPJAX: function() {
      if (!$.support.pjax) {
    ...
    /**
     * Scroll Controls (scroll to top/bottom buttons)
     */
