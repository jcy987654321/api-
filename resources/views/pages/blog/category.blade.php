...
@section('content')
    <div class="d-flex justify-content-between align-items-center mb-3">
        <div>
            <h1 class="h3 mb-1">Category: {{ $category->name }}</h1>
    ...
    <form method="GET" action="{{ route('blog.category', $category->slug) }}" class="card card-body mb-4">
        <div class="row g-3 align-items-end">
            <div class="col-md-10">
                <label class="form-label">Search in this category</label>
