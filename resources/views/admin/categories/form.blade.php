...
@section('title', $mode === 'edit' ? 'Edit Category' : 'Create Category')
@section('page-title', $mode === 'edit' ? 'Edit Category' : 'Create Category')
            ...
            <form method="POST" action="{{ $mode === 'edit' ? route('admin.categories.update', $category->id) : route('admin.categories.store') }}">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" name="slug" value="{{ old('slug', $category->slug) }}" class="form-control @error('slug') is-invalid @enderror" required>
                        @error('slug')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
