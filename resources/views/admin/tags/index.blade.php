...
@section('content')
    ...
    <div class="d-flex justify-content-between align-items-center mb-3">
        <form method="GET" action="{{ route('admin.tags.index') }}" class="d-flex gap-2 align-items-end flex-grow-1 me-3">
            <div class="flex-grow-1">
                <label class="form-label">Search</label>
                <input type="text" name="q" value="{{ $search }}" class="form-control" placeholder="Name">
            </div>
            <div>
                            ...
                            <tr>
                                ...
                                <td class="text-end">
                                    <div class="d-inline-flex gap-2">
                                        ...
                                        <form method="POST" action="{{ route('admin.tags.destroy', $tag->id) }}" onsubmit="return confirm('Delete this tag?');">
                                            @csrf
                                            @method('DELETE')
